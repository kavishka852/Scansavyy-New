        ...
        <View style={{width:'100%', height:'100%', flexDirection:'column', gap:20}}>
              <TouchableOpacity style={{width:'100%',height:height/2 + 150}}>
                  <View style={{width:'100%', height:'100%',position:'relative', backgroundColor:'white', borderRadius:20}}>
                      <Image source={require("../../assets/images/PC/1.jpg")} style={{width:'100%',height:height/2, borderRadius:20, position:'absolute'}} 
                      resizeMode='cover'/>
                      <View style={{width:'100%',flexDirection:'row', alignItems:'center', position:'absolute',bottom:190, left:20}}>
                          ...
                          <View style={{flex:1}}><Text style={{fontWeight:500, fontSize:18, color:'white'}}>1.2k like PC</Text></View>
                      </View>
                      <View style={{width:'100%',position:'absolute',bottom:100}}>
                            <Text style={{fontWeight:500, fontSize:20, color:'black', textAlign:'center'}}>PC new 2024 - VietNam</Text>
                      </View>
                      <TouchableOpacity style={{position:'absolute',bottom:20, left:0, right:0}}>
                          <View style={{width:200, backgroundColor:'orange',borderRadius:100, paddingVertical:15, margin:'auto',flexDirection:'row', alignItems:'center', justifyContent:'center', gap:10}}>
                              ...
                              <Text style={{fontWeight:500, textAlign:'center', fontSize:18, color:'white'}}>Order now</Text>
                          </View>
                      </TouchableOpacity>
                  </View>
              </TouchableOpacity>
              <TouchableOpacity style={{width:'100%',height:height/2 + 150}}>
                  <View style={{width:'100%', height:'100%',position:'relative', backgroundColor:'white', borderRadius:20}}>
                      <Image source={require("../../assets/images/PC/2.jpg")} style={{width:'100%',height:height/2, borderRadius:20, position:'absolute'}} 
                      resizeMode='cover'/>
                      <View style={{width:'100%',flexDirection:'row', alignItems:'center', position:'absolute',bottom:190, left:20}}>
                          <View style={{width:200}}>
                            <View style={{flexDirection:'row', alignItems:'center',position:'relative'}}>
              ...
              <TouchableOpacity style={{width:'100%',height:height/2 + 150}}>
                  <View style={{width:'100%', height:'100%',position:'relative', backgroundColor:'white', borderRadius:20}}>
                      <Image source={require("../../assets/images/PC/3.jpg")} style={{width:'100%',height:height/2, borderRadius:20, position:'absolute'}} 
                      resizeMode='cover'/>
                      <View style={{width:'100%',flexDirection:'row', alignItems:'center', position:'absolute',bottom:190, left:20}}>
                          <View style={{width:200}}>
                            <View style={{flexDirection:'row', alignItems:'center',position:'relative'}}>
              ...
              <TouchableOpacity style={{width:'100%',height:height/2 + 150}}>
                  <View style={{width:'100%', height:'100%',position:'relative', backgroundColor:'white', borderRadius:20}}>
                      <Image source={require("../../assets/images/PC/4.jpg")} style={{width:'100%',height:height/2, borderRadius:20, position:'absolute'}} 
                      resizeMode='cover'/>
                      <View style={{width:'100%',flexDirection:'row', alignItems:'center', position:'absolute',bottom:190, left:20}}>
                          <View style={{width:200}}>
                            <View style={{flexDirection:'row', alignItems:'center',position:'relative'}}>
              ...
              <TouchableOpacity style={{width:'100%',height:height/2 + 150}}>
                  <View style={{width:'100%', height:'100%',position:'relative', backgroundColor:'white', borderRadius:20}}>
                      <Image source={require("../../assets/images/PC/5.jpg")} style={{width:'100%',height:height/2, borderRadius:20, position:'absolute'}} 
                      resizeMode='cover'/>
                      <View style={{width:'100%',flexDirection:'row', alignItems:'center', position:'absolute',bottom:190, left:20}}>
                          <View style={{width:200}}>
                            <View style={{flexDirection:'row', alignItems:'center',position:'relative'}}>
