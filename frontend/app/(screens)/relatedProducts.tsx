...
const RelatedProducts = () => {
    ...
    const [relatedProductLoading, setRelatedProductLoading] = useState<boolean>(true);
    ...
    const fetchData = async () => {
        setTimeout(async () => {
            ...
            setRelatedProducts(JSON.parse(products));
            ...
            <ScrollView style={styles.container}>
                <View style={{width: '100%', paddingHorizontal: 20, marginBottom: 100}}>
                    <View style={{
                        ...
                        {(relatedProducts.length === 0 && !relatedProductLoading) && (
                        ...
                        {!relatedProductLoading && relatedProducts.map((item: any, index: number) => (
                            <View style={styles.cardContainer} key={`related-product-${item._id}-${index}`}>
                                <View
                                    style={styles.card}
                                >
                                    {/* Product Image */}
